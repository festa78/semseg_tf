#!/usr/bin/python3 -B
"""The script to predict VOC2012 data by a dilated network.
"""
...
from src.data.voc import id2trainid_tensor, trainid2color_tensor
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="The script to predict VOC2012 data by a dilation network.")
    parser.add_argument(
        'params_yaml',
        type=str,
        help=
