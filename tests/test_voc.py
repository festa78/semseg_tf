...
class Test(tf.test.TestCase):
    ...
    def test_id2trainid_tensor(self):
        ...
        with tf.Graph().as_default():
            ...
            self.assertEqual(trainid.shape, (IMAGE_HEIGHT, IMAGE_WIDTH, 1))
            # Checks id is correctly converted to trainId.
            self.assertEqual(trainid[0, 0, 0], 8)
    ...
    def test_trainid2color_tensor(self):
        ...
        with tf.Graph().as_default():
            ...
            # Checks output size is correct.
            self.assertEqual(color.shape, (IMAGE_HEIGHT, IMAGE_WIDTH, 3))
            # Checks trainId is correctly converted to color.
            self.assertAllEqual(color[0, 0, :], np.array((0, 128, 0)))
